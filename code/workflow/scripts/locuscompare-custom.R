...
# Original script from git@github.com:boxiangliu/locuscomparer.git
# https://github.com/boxiangliu/locuscomparer/blob/47729dca80f929ea018b5662b12488f3d32cd401/R/locuscompare.R
